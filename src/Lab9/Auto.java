...
public class Auto {
    private int numGos;         //Государственный номер                 //
    ...
    public void setNumGos(int Gos){                                     //
        numGos=Gos;             //значения Государственный номер        //
    }                                                                   //
    public int getNumGos(){                                             //
        return numGos;          //Государственный номер                 //
    }                                                                   //
